//adapted from this tutorial https://itp.nyu.edu/physcomp/labs/labs-serial-communication/lab-midi-output-using-an-arduino/
//written for the teensy 3.1 serial midi or hardware midi
//plays a note when the button is pressed.  note is determined by AnalogValue, and button has to be repressed to hear updated AnalogValue
